...
/**
 * Class TemplateConnectionResolver
 */
class TemplateConnectionResolver extends AbstractConnectionResolver {
	/**
	 * {@inheritDoc}
	 *
	 * @var ?array
	 ...
	 */
	public function __construct( $source, array $args, $context, $info, $template_type = 'wp_template' ) {
	...
	public function get_loader_name() {
		return TemplateLoader::LOADER_NAME;
	}
