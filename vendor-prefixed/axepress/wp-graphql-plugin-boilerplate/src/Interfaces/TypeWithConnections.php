...
namespace WPGraphQL\SiteEditor\Vendor\AxeWP\GraphQL\Interfaces;

if ( ! interface_exists( '\WPGraphQL\SiteEditor\Vendor\AxeWP\GraphQL\Interfaces\TypeWithConnections' ) ) {
