...
use WPGraphQL\SiteEditor\Vendor\AxeWP\GraphQL\Interfaces\TypeWithFields;

if ( ! class_exists( '\WPGraphQL\SiteEditor\Vendor\AxeWP\GraphQL\Abstracts\InterfaceType' ) ) {
