...
namespace WPGraphQL\SiteEditor\Vendor\AxeWP\GraphQL\Abstracts;

use WPGraphQL\SiteEditor\Vendor\AxeWP\GraphQL\Interfaces\TypeWithInputFields;

if ( ! class_exists( '\WPGraphQL\SiteEditor\Vendor\AxeWP\GraphQL\Abstracts\InputType' ) ) {
